    ...
    return (
        <div style={{ display: 'flex', backgroundColor: 'white', width: '100vw', height: '100vh' }}>
            <div style={{
                ...
                <LeftMenu inventory={inventory} setInventory={setInventory} activeMenu={activeMenu} setActiveMenu={setActiveMenu} activeUser={activeUser} setActiveUser={setActiveUser} />
            </div>
            <div style={{ flex: '4', backgroundColor: '', margin: '1rem', marginLeft: '0rem' }}>
                ...
                {email.toLowerCase() === 'user' && <RightMenu activeUser={activeUser} setActiveUser={setActiveUser} inventory={inventory} setInventory={setInventory} />}
            </div>
        </div >
